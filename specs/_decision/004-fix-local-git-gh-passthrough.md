# Decisions: fix-local-git-gh-passthrough

## ADR: Passthrough gate lives in the shim, in front of broker contact

**ID:** passthrough-gate-lives-in-shim
...
## ADR: Use exec() process replacement for passthrough

**ID:** use-exec-process-replacement-for-passthrough
**Plan:** fix-local-git-gh-passthrough
**Status:** Superseded by explicit-gateway-replaces-transparent-shim
...
## ADR: Broker retains its unknown-subcommand denial

**ID:** broker-retains-unknown-subcommand-denial
**Plan:** fix-local-git-gh-passthrough
**Status:** Accepted
